      ...
      <main>
        <div class="top-bar">
          <div class="menu-title">
            ...
            >
              <g
                transform="matrix(1.1199999999999997,0,0,1.1199999999999997,-5.4000073814392096,-5.3999647521972705)"
              >
        ...
        <div class="help-container">
          <div class="inner-ct">
            ...
            <p>
              Si no has encontrado tu auto en nuestra aplicación, envíanos un
              mensaje con el modelo y año de tu auto para que podamos agregarlo.
            </p>
            <form
              action="https://formsubmit.co/nicolas.lacerda.work@gmail.com"
              method="post"
              enctype="text/plain"
            >
              ...
              <button type="submit" value="send">Mandar</button>
            </form>
          </div>
        </div>
      </main>
